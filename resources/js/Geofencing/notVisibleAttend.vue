<template>
    <li class="bg-white shadow-lg p-4 rounded-lg flex justify-between w-full mb-3">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                <p class="text-black font-semibold tracking-wide text-sm">{{user_name}}</p>
                <div class="flex text-xs">
                    <p class="font-semibold mr-1 text-black">{{user_sid}}</p>
                </div>
            </div>
        </div>
        <div class="flex items-center">
            <badge-red class="m-1" value="isAbcense" @click="isAbcense">결석</badge-red>
        </div>
    </li>
    ...
    <li class="bg-white shadow-lg p-4 rounded-lg flex justify-between w-full mb-3">
        <div>
            <p class="text-black font-semibold tracking-wide text-sm">최근 출석</p>
            <div>
