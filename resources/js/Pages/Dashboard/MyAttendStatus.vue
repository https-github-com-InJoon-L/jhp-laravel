<template>
    ...
    <div class="flex  flex-col  md:flex-row justify-center  flex-wrap gap-3  ">
        <div class="min-w-full p-4">
            <div
                class=" bg-white max-w-full shadow-lg   mx-auto border-b-4 border-indigo-400 rounded-2xl overflow-hidden  hover:shadow-2xl transition duration-500 transform hover: cursor-pointer">
                <div class="bg-indigo-400  flex h-20  items-center">
                ...
                <div class="flex justify-center p-3 text-lg gap-5" v-if="total!=0">
        ...
        mounted() {
            axios.get("/api/user/attendStatus/" + this.user_id + '?attend=지각')
                .then(response => {
                    ...
                    this.total = response.data.user_run.total
                })
