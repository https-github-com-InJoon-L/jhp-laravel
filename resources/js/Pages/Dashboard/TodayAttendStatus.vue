<template>
    ...
    <div class="flex  flex-col  md:flex-row justify-center  flex-wrap gap-3  ">
        <div class="min-w-full p-4">
            <div
                class=" bg-white max-w-full shadow-lg   mx-auto border-b-4 border-secondary rounded-2xl overflow-hidden  hover:shadow-2xl transition duration-500 transform hover: cursor-pointer">
                <div class="bg-secondary  flex h-20  items-center">
                    <h1 class="text-white ml-4 border-2 py-2 px-4 rounded-full text-sm font-bold">오늘 자습현황</h1>
                    <p class="ml-2 text-white uppercase text-sm">{{ this.todayWithDay }}</p>
                </div>
                <div class="flex justify-center p-3 text-lg gap-3" v-if="attends[0]">
