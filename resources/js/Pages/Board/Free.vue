<template>
    <app-layout>
        <template #header>
            <div class="tabs">
                <a class="tab  tab-lifted tab-lg font-bold focus:outline-none" :href="route('notice')">공지사항</a>
                <a class="tab  tab-lifted tab-lg font-bold tab-active focus:outline-none" :href="route('free')">자유게시판</a>
            </div>
        </template>
  ...
  <a class="fixed left-1/2 mb-10 transform -translate-x-2/4 bottom-0 bg-indigo-500 text-white p-3 rounded hover:bg-indigo-700 m-2 " v-bind:href="`/freewrite?page=${page.current_page}`" ><i class="fas fa-pen font-xl">글쓰기</i></a>
</div>
        </div>
    </app-layout>
</template>
